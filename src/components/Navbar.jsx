  ...
  return (
    <div>
      <div className='flex justify-between bg-white p-1 md:p-3 '>
        <img className='h-14  object-cover object-center' src='https://tse2.mm.bing.net/th/id/OIP.0yozgFWlW6RlipJCFfn7RwHaHa?pid=Api&h=220&P=0' alt='YOGURJA'/>
      ...
      <div>
<button className='md:hidden' onClick={handle}>{open?<X />:<Menu />}</button>
<div className={`bg-amber-600 rounded-lg absolute top-16 left-5 text-center text-xl transition-all-duration-300 md:hidden ${open?"block":"hidden"}`}>
