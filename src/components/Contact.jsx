      ...
      <div className="flex flex-col md:flex-row justify-between gap-8 px-6">
        <div className="flex flex-col gap-5 md:w-1/4">
          ...
          <p className="font-serif text-sm">
            Yogurja Wellness Center, Building A7 EnviroCare,
            <br />
            MIDC Main Road, Wagle Industrial Estate,
            <br />
        ...
        <div className="w-[2px] bg-black opacity-55 hidden md:block"></div>
        <div className="md:w-1/2">
          ...
          <form
            onSubmit={handle}
            className="grid gap-4 opacity-75 transition-all duration-300"
          >
            <div>
              <label className="font-serif text-sm">Your Name</label>
              <input
                ref={name}
                className="w-full border-2 p-2 border-zinc-300 rounded-md outline-0 hover:shadow-md active:scale-101"
              />
            </div>
            ...
            <div className="md:col-span-2 text-center">
              <button className="bg-orange-500 text-white px-6 py-2 mt-4 font-bold rounded-lg active:scale-95">
                ASK A QUESTION
              </button>
            </div>
          </form>
