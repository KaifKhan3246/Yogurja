...
import Service2data from '/Service2data'
...
const Service2 = () => {
  return (
   ...
   <span className='font-serif font-semibold text-white'><Link className='text-orange-500' to='/'>Home</Link>/Physiotherapy</span>
         </div>
         <div className=' flex justify-center items-center font-semibold md:text-3xl text-xl font-serif mt-10'>
   <h1 className='uppercase'>physiotherapy</h1>
         </div><div className='flex md:flex-row flex-wrap m-10 gap-12'>
           {Service2data.map((seri)=>(
